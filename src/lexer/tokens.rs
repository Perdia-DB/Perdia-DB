...
pub fn initialize() -> Vec<TokenDefinition> {
    ...
    token_definitions.push(TokenDefinition::new(Token::Select, r"SELECT", 1));
    token_definitions.push(TokenDefinition::new(Token::Value, r#"VALUE"#, 1));
    token_definitions.push(TokenDefinition::new(Token::From, r#"FROM"#, 1));
    token_definitions.push(TokenDefinition::new(Token::Create, r"CREATE", 1));
    token_definitions.push(TokenDefinition::new(Token::Template, r"TEMPLATE", 1));
    token_definitions.push(TokenDefinition::new(Token::Instance, r#"INSTANCE"#, 1));
